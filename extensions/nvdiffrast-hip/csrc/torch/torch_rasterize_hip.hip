...
#include "../common/hipraster/CudaRaster.hpp"
#include "../common/hipraster/impl/Constants.hpp"
#include <tuple>
...
{
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(cudaDeviceIdx_);
...
{
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(cudaDeviceIdx);
    delete cr;
}
...
{
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(device_of(pos));
    ...
    // Launch CUDA kernel.
    void* args[] = {&p};
    NVDR_CHECK_CUDA_ERROR(hipLaunchKernel((void*)RasterizeCudaFwdShaderKernel, gridSize, blockSize, args, 0, stream));
...
torch::Tensor rasterize_grad_db(torch::Tensor pos, torch::Tensor tri, torch::Tensor out, torch::Tensor dy, torch::Tensor ddb)
{
    ...
    NVDR_CHECK_CUDA_ERROR(hipLaunchKernel(reinterpret_cast<const void*>(func), gridSize, blockSize, args, 0, stream));
